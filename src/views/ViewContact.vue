            ...
            <div class="border border-gold/20 p-8 mb-8 relative">
                ...
                <div class="flex flex-col gap-3">
                    <a :href="`mailto:${ABOUT.email}`"
                        class="flex items-center justify-center gap-3 font-mono-rpg text-sm text-[#e8dfc8]/80 border border-gold/20 px-6 py-3 hover:border-gold hover:text-gold transition-all min-h-[44px]">
